...
COLOR_WALL    = st7789.WHITE
COLOR_SNAKE   = st7789.GREEN
COLOR_APPLE   = st7789.RED
COLOR_SCORE   = st7789.YELLOW
COLOR_LOST_BG = st7789.WHITE
COLOR_LOST_FG = st7789.BLACK
MODE_MENU     = 0
MODE_START    = 1
MODE_READY    = 2
MODE_PLAY     = 3
...
def drawGameMenu():
    global SNAKE_SIZE
    g.display.text(font, 'Snake', 10, 0, st7789.WHITE)
    g.display.text(font, "A START", 10, 16, st7789.WHITE)
    if game['demo'] :
        g.display.text(font, 'B AI-Player', 10, 32, st7789.WHITE)
    else :
        g.display.text(font, 'B 1-PLAYER', 10, 32, st7789.WHITE)
    g.display.text(font, "  SIZE {}".format(SNAKE_SIZE),10,48,st7789.WHITE)
    g.display.text(font, "  FPS {}".format(g.frameRate),10,64,st7789.WHITE)
...
def drawScore():
    g.display.text(font, 'S {}'.format(game['score'] ), 10, 0, st7789.YELLOW)
    g.display.text(font, 'L {}'.format( game['life'] ), 80, 0, st7789.YELLOW)
